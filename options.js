    ...
    backgroundSelection.on('select', id => {
        ...
        if (id === 'none') {
            ...
            switch(id) {
                 case 'edge':
                    app.destroyParticles();
                    particlesJS.load('.particles', './json/squares.json');
                    break;
                case 'particles':
                    app.destroyParticles();
    ...
    tabs.createTab('tabs', app.createElement('div', [
        app.createElement('section', [
            ...
            app.createElement('section', [
                ...
                app.createElement('p', 'Change the title of Diamond\'s browser tab title.', {
                    style: {
                        'margin-bottom': '0'
                    }
                })
            ...
            app.createElement('section', [
                ...
                app.createElement('p', 'Change the icon of Diamond\'s browser tab. To change it into something like Google, type in "https://www.google.com/favicon.ico"', {
                    style: {
                        'margin-bottom': '0'
                    }
                })
...
*/
            ...
            app.createElement('section', [
                ...
                app.createElement('p', 'The URL that Diamond redirects to when using about:blank.', {
                    style: {
                        'margin-bottom': '0'
                    }
                })
...
async function tabURL(url) {
    // A mess of code from Tsunami 2.0 and HolyUB modified to work with Diamond
